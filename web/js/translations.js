const TRANSLATIONS = {
  ...
  ES: {
    ...
    factor: "Factor a",
    time: "Tiempo t", systems: "Sistemas de ecuaciones", advanced: "Avanzada", simpleMode: "Favorables / totales", dieOne: "Un dado", diceTwo: "Dos dados", customDice: "Dados personalizados", diceMode: "Configuración de dados", probabilityKind: "Pregunta", target: "Objetivo", sideCount: "Caras del primer dado", secondSideCount: "Caras del segundo dado", comparison: "Comparación", equal: "Igual a", greater: "Mayor que", less: "Menor que", greaterEqual: "Mayor o igual que", lessEqual: "Menor o igual que", atLeast: "Al menos", divisible: "Divisible / cociente entero", value: "Valor", sum: "Suma", product: "Producto", atLeastOne: "Al menos un dado es igual a", totalOutcomes: "Resultados totales", favorableOutcomes: "Resultados favorables", favorablePairs: "Parejas favorables", unique: "Solución única", none: "Sin solución", infinite: "Infinitas soluciones", targetValue: "Valor objetivo (opcional)", growthPercent: "Tasa de crecimiento", decreasePercent: "Tasa de disminución", solveValue: "Evaluar t", solveTime: "Despejar t", hypotenuse: "Hipotenusa", angle: "Ángulo (grados)", slope: "Pendiente m", quotient: "Cociente entero", systemA1: "Ecuación 1: coeficiente de x", systemB1: "Ecuación 1: coeficiente de y", systemC1: "Ecuación 1: lado derecho", systemA2: "Ecuación 2: coeficiente de x", systemB2: "Ecuación 2: coeficiente de y", systemC2: "Ecuación 2: lado derecho", linearSystem: "Sistema lineal", quadraticLinearSystem: "Sistema cuadrático-lineal", quadraticSystemA: "Coeficiente cuadrático a", quadraticSystemB: "Coeficiente lineal b", quadraticSystemC: "Constante c", systemLineSlope: "Pendiente d", systemLineIntercept: "Término independiente e",
  },
  ...
  FI: {
    ...
    factor: "Kerroin a",
    time: "Aika t", systems: "Yhtälöparit", advanced: "Edistynyt", simpleMode: "Suotuisat / kaikki", dieOne: "Yksi noppa", diceTwo: "Kaksi noppaa", customDice: "Omat nopat", diceMode: "Nopat", probabilityKind: "Kysymys", target: "Tavoite", sideCount: "Ensimmäisen nopan sivut", secondSideCount: "Toisen nopan sivut", comparison: "Vertailu", equal: "Yhtä kuin", greater: "Suurempi kuin", less: "Pienempi kuin", greaterEqual: "Suurempi tai yhtä suuri kuin", lessEqual: "Pienempi tai yhtä suuri kuin", atLeast: "Vähintään", divisible: "Jaollisuus / kokonaislukusuhde", value: "Arvo", sum: "Summa", product: "Tulo", atLeastOne: "Vähintään yksi noppa on", totalOutcomes: "Kaikki tulokset", favorableOutcomes: "Suotuisat tulokset", favorablePairs: "Suotuisat parit", unique: "Yksi ratkaisu", none: "Ei ratkaisua", infinite: "Äärettömän monta ratkaisua", targetValue: "Tavoitearvo (valinnainen)", growthPercent: "Kasvuprosentti", decreasePercent: "Vähenemisprosentti", solveValue: "Laske f(t)", solveTime: "Ratkaise t", hypotenuse: "Hypotenuusa", angle: "Kulma (astetta)", slope: "Kulmakerroin m", quotient: "Kokonaislukusuhde", systemA1: "1. yhtälö: x:n kerroin", systemB1: "1. yhtälö: y:n kerroin", systemC1: "1. yhtälö: oikea puoli", systemA2: "2. yhtälö: x:n kerroin", systemB2: "2. yhtälö: y:n kerroin", systemC2: "2. yhtälö: oikea puoli", linearSystem: "Lineaarinen yhtälöpari", quadraticLinearSystem: "Toisen asteen yhtälöpari", quadraticSystemA: "Toisen asteen kerroin a", quadraticSystemB: "Lineaarinen kerroin b", quadraticSystemC: "Vakiotermi c", systemLineSlope: "Suoran kulmakerroin d", systemLineIntercept: "Suoran vakiotermi e",
  },
};
...
Object.assign(TRANSLATIONS.EN, {navVat:"VAT", indexedValue:"Indexed value", base100:"Base-100 series", unitEconomics:"Per-unit / break-even", quantity:"Quantity", price:"Selling price per unit", variableUnit:"Variable cost per unit", fixed:"Fixed costs", mode:"Mode", netToGross:"Net price to gross price", grossToNet:"Gross price to net price", amount:"Amount", rate:"VAT rate %", startCapital:"Starting capital", taxRate:"Annual tax %", growthYears:"Number of years", taxedGrowth:"Growth with tax", indexedSeries:"Values (2–6)", baseValue:"Base value", oldIndex:"Old index", newIndex:"New index", less:"Less than", greaterEqual:"Greater than or equal to", lessEqual:"Less than or equal to"});
Object.assign(TRANSLATIONS.ES, {navVat:"IVA", indexedValue:"Valor indexado", base100:"Serie base 100", unitEconomics:"Por unidad / punto de equilibrio", quantity:"Cantidad", price:"Precio de venta por unidad", variableUnit:"Coste variable por unidad", fixed:"Costes fijos", mode:"Modo", netToGross:"Precio neto a precio bruto", grossToNet:"Precio bruto a precio neto", amount:"Importe", rate:"% de IVA", startCapital:"Capital inicial", taxRate:"% de impuesto anual", growthYears:"Número de años", taxedGrowth:"Crecimiento con impuesto", indexedSeries:"Valores (2–6)", baseValue:"Valor base", oldIndex:"Índice antiguo", newIndex:"Índice nuevo", less:"Menor que", greaterEqual:"Mayor o igual que", lessEqual:"Menor o igual que"});
Object.assign(TRANSLATIONS.FI, {navVat:"ALV", indexedValue:"Indeksoitu arvo", base100:"Perusindeksisarja", unitEconomics:"Kappalekohtainen / kriittinen piste", quantity:"Määrä", price:"Myyntihinta yksiköltä", variableUnit:"Muuttuva kustannus yksiköltä", fixed:"Kiinteät kustannukset", mode:"Tila", netToGross:"Verottomasta verolliseen", grossToNet:"Verollisesta verottomaan", amount:"Summa", rate:"ALV-prosentti", startCapital:"Alkupääoma", taxRate:"Vuosittainen vero-%", growthYears:"Vuosien määrä", taxedGrowth:"Verotettu kasvu", indexedSeries:"Arvot (2–6)", baseValue:"Perusarvo", oldIndex:"Vanha indeksi", newIndex:"Uusi indeksi", less:"Pienempi kuin", greaterEqual:"Suurempi tai yhtä suuri kuin", lessEqual:"Pienempi tai yhtä suuri kuin"});
...
Object.assign(TRANSLATIONS.FI, {
  quantityOptional: "Määrä (valinnainen)",
});
