...
Object.assign(TRANSLATIONS.ES, {navVat:"IVA", indexedValue:"Valor indexado", base100:"Serie base 100", unitEconomics:"Por unidad / punto de equilibrio", quantity:"Cantidad", price:"Precio de venta por unidad", variableUnit:"Coste variable por unidad", fixed:"Costes fijos", mode:"Modo", netToGross:"Neto a bruto", grossToNet:"Bruto a neto", amount:"Importe", rate:"% de IVA", startCapital:"Capital inicial", taxRate:"% de impuesto anual", growthYears:"Número de años", taxedGrowth:"Crecimiento con impuesto", indexedSeries:"Valores (2–6)", baseValue:"Valor base", oldIndex:"Índice antiguo", newIndex:"Índice nuevo", less:"Menor que", greaterEqual:"Mayor o igual que", lessEqual:"Menor o igual que"});
Object.assign(TRANSLATIONS.FI, {navVat:"ALV", indexedValue:"Indeksoitu arvo", base100:"Perusindeksisarja", unitEconomics:"Kappalekohtainen / kriittinen piste", quantity:"Määrä", price:"Myyntihinta yksiköltä", variableUnit:"Muuttuva kustannus yksiköltä", fixed:"Kiinteät kustannukset", mode:"Tila", netToGross:"Netosta brutoksi", grossToNet:"Brutosta netoksi", amount:"Summa", rate:"ALV-prosentti", startCapital:"Alkupääoma", taxRate:"Vuosittainen vero-%", growthYears:"Vuosien määrä", taxedGrowth:"Verotettu kasvu", indexedSeries:"Arvot (2–6)", baseValue:"Perusarvo", oldIndex:"Vanha indeksi", newIndex:"Uusi indeksi", less:"Pienempi kuin", greaterEqual:"Suurempi tai yhtä suuri kuin", lessEqual:"Pienempi tai yhtä suuri kuin"});
